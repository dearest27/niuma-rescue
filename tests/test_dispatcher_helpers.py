...
class ClarifyRoutingTest(unittest.TestCase):
    def test_clean_clear_routes_to_clear(self) -> None:
        v, payload = dispatcher.route_clarify("CLEAR\n\n## 背景\n做一件事")
